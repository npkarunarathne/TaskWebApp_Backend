...
namespace TaskWebApp.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public UserController(UserManager<IdentityUser> userManager, JwtSettings jwtSettings, TaskWebAppContext context,
        ...
        public async Task<ActionResult> UserRegister([FromBody] UserRegistration request)
        {
            ...
            try
            {
                ...
                await using var connection = new SqlConnection(Configuration.GetConnectionString("TaskWebAppContextConnection"));
